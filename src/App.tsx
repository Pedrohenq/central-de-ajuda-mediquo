  ...
  const TicketDetailForm = ({ typeId }: { typeId: string }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      const formBody = new URLSearchParams({
        "form-name": "chamado-suporte",
        "Formulario": ticket?.title || 'Geral',
        ...formData
      }).toString();
    ...
    if (isSubmitted) {
      return (
        <div className="max-w-2xl mx-auto px-4 py-12 text-center">
          ...
          <h2 className="text-3xl font-black text-gray-800 mb-4 tracking-tight">Recebemos seu chamado!</h2>
          <p className="text-gray-500 text-lg mb-8 max-w-md mx-auto">
            Nossa equipe já foi notificada e responderá para o e-mail <strong>{formData.Email}</strong> em breve.
          </p>
          <button
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[2rem] shadow-2xl p-6 sm:p-10 border border-gray-100 space-y-6">
          <input type="hidden" name="form-name" value="chamado-suporte" />
            ...
            <div className="max-w-6xl mx-auto px-4 text-center">
              ...
              <div className="max-w-2xl mx-auto relative">
                ...
                >
                  ...
                  <button type="submit" className="absolute right-3 top-1/2 -translate-y-1/2 bg-purple-600 text-white px-6 py-2.5 rounded-xl font-bold hidden sm:block active:scale-95 transition-transform">Buscar</button>
                  {searchTerm && (
                    <button 
                      type="button"
                      onClick={() => setSearchTerm('')} 
